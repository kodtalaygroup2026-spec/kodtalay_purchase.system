      ...
      <table className="min-w-full text-sm">
        <thead className="border-b border-slate-100 bg-slate-50">
          <tr>
            ...
            <SortTh label="หมวดหมู่"   col="category_name" activeCol={sortKey} dir={sortDir} onSort={handleSort} className="hidden md:table-cell" />
            <SortTh label="หน่วย"     col="unit"          activeCol={sortKey} dir={sortDir} onSort={handleSort} className="hidden sm:table-cell" />
